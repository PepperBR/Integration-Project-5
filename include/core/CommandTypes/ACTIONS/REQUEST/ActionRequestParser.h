...
private:
    ...
    static auto verifyWithFirstPblock(const std::vector<uint8_t> &data) -> VerifyFrameResponse;
    static auto verifyWithListAndFirstPblock(const std::vector<uint8_t> &data) -> VerifyFrameResponse;
